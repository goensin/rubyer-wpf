...
{
    /// <summary>
    /// This class was initially based on work done in MaterialDesignInXamlToolkit
    ...
    public class PopupEx : Popup
    {
        ...
        private void Element_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            do
            {
                ...
                {
                    if (parent is FrameworkElement popupRoot)
                    {
                        popupRoot.Height = element.ActualHeight;
                        popupRoot.Width = element.ActualWidth;
                    }
